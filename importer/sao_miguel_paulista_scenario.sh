...
# TODO There's an updated version only in an email right now
wget https://github.com/spstreets/OD2017/releases/download/1/all_trips.json
cargo run --release --bin cli -- import-scenario --map=data/system/br/sao_paulo/maps/sao_miguel_paulista.bin --input=all_trips.json --skip-problems
